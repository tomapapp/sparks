...
recommendation_attributes = [
  ...
  },
  {
    ...
    location: "150 Furman St, Pier 2, Brooklyn, NY 11201",
    rating: rand(30..50).to_f/10,
    price: 20,
    category_id: Category.find_by(name: "Outdoors").id
  },
  ...
  },
{
  ...
  },
  {
    ...
    location: "138 Wooster St floor 2, New York, NY 10012",
    rating: rand(30..50).to_f/10,
    price: 50,
    category_id: Category.find_by(name: "Bars").id
  },
  ...
  },
  {
    ...
    location: "117 MacDougal St #1267, New York, NY 10012",
    rating: rand(30..50).to_f/10,
    price: 75,
    category_id: Category.find_by(name: "Theater").id
  },
  ...
  },
  {
    ...
    location: "6036 Broadway, Van Cortlandt Park, The Bronx, NY 10471",
    rating: rand(30..50).to_f/10,
    price: 10,
    category_id: Category.find_by(name: "Museums").id
  },
